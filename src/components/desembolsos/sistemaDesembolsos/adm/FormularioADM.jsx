...
export default function FormularioADM({ grillaAdm }) {
  ...
  useEffect(() => {
    const planSeleccionadoAdm = grillaAdm.find(p => p.montoNeto === Number(formData.monto));

    if (planSeleccionadoAdm && formData.cantCuotas) {
      let valorMontoCuota = '';

      switch (String(formData.cantCuotas)) {
        case "12":
          valorMontoCuota = planSeleccionadoAdm.plazo12;
          break;
        case "18":
          valorMontoCuota = planSeleccionadoAdm.plazo18;
          break;
        case "24":
          valorMontoCuota = planSeleccionadoAdm.plazo24;
          break;
        default:
          valorMontoCuota = '';
      }
  ...
  useEffect(() => {
    const planSel = grillaAdm.find(p => p.montoNeto === Number(formData.monto));
    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-4xl mx-auto">
      ...
      {Adm && (
        <div className="mt-10 flex justify-center mb-10">
          <a
            href={URL.createObjectURL(Adm)}
            download={nombreAdm || "archivo.docx"}
