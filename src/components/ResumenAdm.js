...
function ResumenAdm({ resultados }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="col-span-1">
          <h2
            ...
            data-tooltip-content="Este contenedor muestra informacion del RESUMEN DE ADM"
            data-tooltip-position-strategy="fixed"
          >
            RESUMEN COBRANZA ADM
          </h2>
        </div>
          ...
          <tbody>
            {resultados.length === 0 && (
              <tr>
                ...
                >
                  No se encontraron resultados en el RESUMEN ADM.
                </td>
              </tr>
            )}
      ...
      {/* Sección de Datos de Cobranza 2024 */}
